...
$app->get('/rental', function (Request $request, Response $response, array $arg){
    ...
    return $response->withJson(array('data' => 'success'), 200); });  
...
$app->post('/rental/add', function ($request, $response, $args) { 
    ...
    if (is_null($data)) { 
        ...
        return $this->response->withJson(array('error' => 'Failed to create rental'), 500); 
} 
    return $this->response->withJson(array('data' => $data), 200); }); 
...
$app->put('/rental/put/[{id}]', function ($request, $response, $args){
    ...
    if (!is_numeric($rentalId)) { 
        ...
        if ($data <= 0) {
            return $this->response->withJson(array('error' => 'Failed to update rental'), 500); 
        }
...
//post method order
$app->post('/buy/add', function ($request, $response, $args) { 
